...
public class MeleeWeaponTrail : MonoBehaviour
{
	...
	void Start()
	{
		...
		//By me
		//_trailObject.renderer.material.SetTextureScale("_MainTex", trailController.v2_Tiling);
		//if(trailController != null){

		//      if (trailController.material != null)
		//      {
		//            _trailObject.renderer.material = trailController.material;
		//      }
		//      else {
		//            //Debug.Log("dfghjkk");
		//      }
		//}else{
		//      //Debug.Log("dfhgjhkjlk");
		//}
