...
public class HttpClient
{
	...
	#if TEST
	public static string USER_CENTER = @"http://192.168.1.110:8080/UserCenter/game/testServerList";
	#else
	public static string USER_CENTER = @"http://101.251.238.247:8080/UserCenter/game/testServerList";
	#endif
